...
if __name__=='__main__':
    ...
    while (1):
        ...
        # pg_cost = sqlSample.getDPlantecy() # Just let postgres to execute the sql - not the relating thing
        ...
        for t in count():
            ...
            ###print("[run.py]: chosen_action: ",chosen_action, ", chosen_cost: ", chosen_cost)
            ...
            ###print("[run.py]: reward: ", reward, ", done: ",done)
            if done:
                ###print("\n\n===done===")
                ###for row in reward:
                    ###print(row)
