...
if __name__=='__main__':
    TrainQueries = QueryLoader(QueryDir=config.hanwenTrainDir)
    print(len(TrainQueries))
    TestQueries = QueryLoader(QueryDir=config.hanwenTestDir)
    print(len(TestQueries))

    train(TrainQueries, TestQueries)
